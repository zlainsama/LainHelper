...
public class MasterEffect implements Cheat {
    ...
    private static final AttributeModifier NormalArmorModifier = new AttributeModifier(ArmorModifierID, ArmorModifierID.toString(), 8.0D, AttributeModifier.Operation.ADDITION);
