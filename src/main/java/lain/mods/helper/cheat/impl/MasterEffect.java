...
public class MasterEffect implements Cheat {
    ...
    private static final AttributeModifier MasterArmorModifier = new AttributeModifier(ArmorModifierID, ArmorModifierID.toString(), 20.0D, AttributeModifier.Operation.ADDITION);
    private static final AttributeModifier MasterArmorToughnessModifier = new AttributeModifier(ArmorToughnessModifierID, ArmorToughnessModifierID.toString(), 12.0D, AttributeModifier.Operation.ADDITION);
    ...
    private static final AttributeModifier NormalArmorModifier = new AttributeModifier(ArmorModifierID, ArmorModifierID.toString(), 20.0D, AttributeModifier.Operation.ADDITION);
    private static final AttributeModifier NormalArmorToughnessModifier = new AttributeModifier(ArmorToughnessModifierID, ArmorToughnessModifierID.toString(), 12.0D, AttributeModifier.Operation.ADDITION);
